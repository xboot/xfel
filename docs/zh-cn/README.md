...
usage:
    ...
    xfel sdcard                                         - 检测 sdcard
    xfel sdcard read <address> <length> <file>          - 读取 sdcard 到文件
    xfel sdcard write <address> <file>                  - 将文件写入 sdcard
...
| R818 | Quad-Core Cortex-A53 | 0x00185500 | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
